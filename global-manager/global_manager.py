...
def get_credential():
    ...
    Requires a valid ``az login`` session (when AZURE_TOKEN_CREDENTIALS=AzureCliCredential).
    Returns a credential instance after verifying it can obtain a Dataverse token.
    """
